...
$qry = "SELECT sh.section_file,sh.id,sh.section_title FROM `section_home` sh INNER JOIN grt_client_sections cs on sh.id = cs.section_id AND  cs.section_status=0 and cs.client_id= $_SESSION[active_user]";
