...
$qry = "SELECT * FROM `grt_section_events` WHERE section_id=2 and section_client= $_SESSION[active_user]";
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="./section_event_add" class="btn btn-primary btn-sm">
                    ...
                    <tbody>
                        ...
                        if ($result_data != 0) {
                            ...
                            foreach ($result_data as $key => $values) {
                                ...
                                <tr>
                                    <td><a href="#"><?= $sno ?></a></td>
                                    <td><?= $values['section_id'] ?></td>
                                    <td><?= $values['section_text'] ?></td>
                                    <td><?= $values['section_heading'] ?></td>
                                    <td><?= $values['section_sequence'] ?></td>


                                    <td><a href="./menu_update?menu_id=50" class="btn btn-sm   btn-primary">Edit</a>
